...
void spec2::hif_cone__24_()
{
    ...
    _19_ = muffin::inject( hif_fault_node.instance, 20ULL, 1ULL, _01_ && _07_ );
    _21_ = muffin::inject( hif_fault_node.instance, 21ULL, 1ULL, _15_ && _18_ );
