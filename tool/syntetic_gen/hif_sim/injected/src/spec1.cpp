...
void spec1::hif_cone__24__1()
{
    _25_ = muffin::inject( hif_fault_node.instance, 0ULL, 1ULL, !(*hif_a2t_data.b_2
            ) );
    _13_ = muffin::inject( hif_fault_node.instance, 1ULL, 1ULL, !(*hif_a2t_data.a_2
            ) );
    _30_ = muffin::inject( hif_fault_node.instance, 2ULL, 1ULL, !_37_ );
    _31_ = muffin::inject( hif_fault_node.instance, 3ULL, 1ULL, !(*hif_a2t_data.c_2
            ) );
    ...
    _17_ = muffin::inject( hif_fault_node.instance, 9ULL, 1ULL, _16_ && *hif_a2t_data.a_2
         );
    _00_ = muffin::inject( hif_fault_node.instance, 10ULL, 1ULL, _35_ && _36_ );
...
void spec1::hif_cone__29__0()
{
    _13_ = muffin::inject( hif_fault_node.instance, 28ULL, 1ULL, !(*hif_a2t_data.a_2
            ) );
    _30_ = muffin::inject( hif_fault_node.instance, 29ULL, 1ULL, !_37_ );
    _31_ = muffin::inject( hif_fault_node.instance, 30ULL, 1ULL, !(*hif_a2t_data.c_2
            ) );
    ...
    _11_ = muffin::inject( hif_fault_node.instance, 36ULL, 1ULL, _05_ && _08_ );
    _09_ = muffin::inject( hif_fault_node.instance, 37ULL, 1ULL, _02_ && _08_ );
    _07_ = muffin::inject( hif_fault_node.instance, 38ULL, 1ULL, !_06_ );
    _03_ = muffin::inject( hif_fault_node.instance, 39ULL, 1ULL, _02_ && _36_ );
