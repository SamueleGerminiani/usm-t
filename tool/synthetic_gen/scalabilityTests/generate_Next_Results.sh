...
if [ ! -f "$USMT_ROOT/tool/synthetic_gen/raw_challenges/Next_Results/${test_type}_next_summary_report.csv" ]; then
    echo "Experiment,Nant,Ncon,Nspec,Overlap,Time,Design_Lines" > "$USMT_ROOT/tool/synthetic_gen/raw_challenges/Next_Results/${test_type}_next_summary_report.csv"
fi
...
for param in $param_list; do
    ...
    echo "Next,${nant},${ncon},${nspec},${overlap},${elapsed_time},${design_lines}" >> "$USMT_ROOT/tool/synthetic_gen/raw_challenges/Next_Results/${test_type}_next_summary_report.csv"
