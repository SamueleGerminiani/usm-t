...
if [ ! -f "$USMT_ROOT/tool/synthetic_gen/raw_challenges/And_Results/summary_report.csv" ]; then
    echo "Experiment,Nant,Ncon,Nspec,Overlap,Elapsed_Time(s),Design_Lines" > "$USMT_ROOT/tool/synthetic_gen/raw_challenges/And_Results/summary_report.csv"
fi
...
for param in $param_list; do
    ...
    echo "And,${nant},${ncon},${nspec},${overlap},${elapsed_time},${design_lines}" >> "$USMT_ROOT/tool/synthetic_gen/raw_challenges/And_Results/summary_report.csv"
