...
void spec4::update_input_queue( bool synch_phase )
{
    process_in_queue = false;
...
void spec4::flag_elaboration()
{
}


void spec4::start_of_simulation()
{
    *hif_a2t_data.c_4 = true;
}


void spec4::initialize()
{
    start_of_simulation();
}
