...
( "max-mined", "maximun number of mined specifications to be used in the evaluation for each miner (default is too use all mined specifications). The selected subset of specifications is chosen at random", cxxopts::value<std::string>(), "<INT>")
( "sva", "output specifications in SystemVerilog Assertion format")
( "psl", "output specifications in PSL format")
( "spotltl", "output specifications in spotLTL format")
